    ...
    class TestMovingAverage(unittest.TestCase):
        ...
        def test_List(self):
            ...
            self.assertEqual(list(movingaverage(map(float, [1, 2, 3, 4, 5, 6]), 2)),
                             [1.5, 2.5, 3.5, 4.5, 5.5])
            self.assertEqual(
                list(movingaverage([1, 2, 3, 4, 5, 6], 3)), [2, 3, 4, 5])
            self.assertEqual(
                list(movingaverage([1, 2, 3, 4, 5, 6], 4)), [2.5, 3.5, 4.5])
            self.assertEqual(
                list(movingaverage([1, 2, 3, 4, 5, 6], 5)), [3, 4])
        ...
        def test_XRange(self):
            ...
            self.assertEqual(
                list(movingaverage(xrange(1, 7), 3)), [2, 3, 4, 5])
            self.assertEqual(
                list(movingaverage(xrange(1, 7), 4)), [2.5, 3.5, 4.5])
        ...
        def test_ListRolling(self):
            ...
            try:
                list(movingaverage([1, 2, 3, 4, 5, 6],
                                   7, avoid_fp_drift=False))
                self.fail('Did not raise ValueError on subset_size > len(data)')
            except ValueError:
                pass
